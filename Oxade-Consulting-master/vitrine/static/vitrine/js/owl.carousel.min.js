...
function(a, b, c, d) {
    ...
    e.Defaults = {
        ...
        navSpeed: !1,
        navElement: 'button aria-label="button" role="presentation"',
        navContainer: !1,
        ...
        }, this)), c.dotsData || (this._templates = [a("<button>").addClass(c.dotClass).attr('aria-label', 'dot').append(a("<span>")).prop("outerHTML")]), this._controls.$absolute = (c.dotsContainer ? a(c.dotsContainer) : a("<div>").addClass(c.dotsClass).appendTo(this.$element)).addClass("disabled"), this._controls.$absolute.on("click", "button", a.proxy(function(b) {
